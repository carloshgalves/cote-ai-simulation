...
Current phase: architectural and domain discovery. Prefer `research`, `domain-modeling`, `character-fidelity`, `agent-memory-rag`, `knowledge-boundary-audit`, and `exam-modeling` before `implement` unless an accepted spec or ticket already exists.
